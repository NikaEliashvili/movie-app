  ...
  return (
    <div className="text-orange-600 flex justify-center items-center gap-5 w-full py-4 ">
      ...
      >
        <a
          href="#topBorder"
          className="w-full flex flex-row text-center justify-center items-center py-1 pr-5 pl-2 scroll-smooth cursor-default"
        >
      ...
      >
        <a
          href="#topBorder"
          className="w-full flex flex-row text-center justify-center items-center py-1 pl-5 pr-2 scroll-smooth cursor-default"
        >
          Next
